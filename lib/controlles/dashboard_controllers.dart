...
// --- 2. CONTROLLER (LOGIKA DATA) ---
class DashboardController extends GetxController {
  // .obs membuat list ini reaktif (otomatis update tampilan saat data berubah)
  ...
  // Fungsi jika ingin menambah data atau refresh data dari API nanti
  void refreshData() {
    // Logika ambil data dari database/API ditaruh di sini
  }
}

// --- 3. DASHBOARD PAGE (TAMPILAN) ---
class DashboardPage extends StatelessWidget {
  DashboardPage({super.key});

  // Memanggil controller menggunakan Get.put
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // Menggunakan Obx agar ListView update otomatis saat data di controller berubah
              Obx(
                () => ListView.builder(
                  shrinkWrap: true,
